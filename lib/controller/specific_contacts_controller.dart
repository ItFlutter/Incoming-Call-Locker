...
import 'package:incoming_call_locker/data/model/contacts_model.dart';
...
class SpecificContactsController extends GetxController {
  ...
  onTapContact(int index) {
    ...
    if (contactsModel[index].isSelected == true) {
      ...
      print("========== Add ========== ${contactsModel[index].name}");
      print("========== contactsSpecified ========== $contactsSpecified");
    } else {
      contactsSpecified
          .removeWhere((element) => element.name == contactsModel[index].name);
      print("========== Remove ========== ${contactsModel[index].name}");
      print("========== contactsSpecified ========== $contactsSpecified");
    }
    update();
  }
  ...
  getContactsFromPackage() async {
    ...
    if (contacts.isNotEmpty) {
      contactsModel.addAll(contacts.map((e) {
        if (e.phones!.isEmpty) {
          print("========== EmptyListPhones ==========");
          print("========== name of contact empty ========== ${e.displayName}");
  ...
  void onInit() {
    ...
    print("========== selectedContactType ========== $selectedContactType");
