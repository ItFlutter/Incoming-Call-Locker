...
//                     Launch the Flutter activity
                        if (MainActivity().isFlutterAppRunning()) {
                            ...
                            lockactivited =
                                sharedPreferences.getBoolean("flutter.lockactivited", false)
                            callingsetting =
                                sharedPreferences.getLong("flutter.callingsetting", 0).toInt()
                            ...
                            if (lockactivited == true) {
                                if (callingsetting == 1 && callerName == "") {
                                    ...
                                    methodChannel?.invokeMethod(
                                        "incomingCall",
                                        mapOf("number" to incomingNumber, "name" to callerName)
                                    )
                                }
                                if (callingsetting == 0) {
...
//                }
                    TelephonyManager.EXTRA_STATE_IDLE -> {
                        ...
                        val startActivity =
                            sharedPreferences.getString("flutter.startactivity", "");
